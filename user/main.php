<style>
    ...
    .btn{
        ...
        padding: 10px 20px;
        border-radius: 8px; 
        background-color: rgb(64, 92, 245);
        font-size: large;
        border: none;
        color: #fff;
    }
...
<img class="bg-img" src="./images/loan.jpg">
<div class="carts">
    <h1 style="text-align:center;padding-top:20px;">Personal Loan</h1>
    <div class="cart1">
        <img style="border-radius:10px;width:390px;height:300px;" src="./images/personal_loan.jpg" alt="personal loan Image">
    ...
    assessment of your loan application.
        <button class="btn" onclick="window.location.href = './pages/personal_loan.php'">Apply</button>
    </pre>
</div>
</div>
<!-- ======cart1========== -->
<div class="carts">
    ...
    <div class="cart1">
        <img style="border-radius:10px;width:390px;height:300px;" src="./images/business_loan.jpg" alt="personal loan Image">
        <pre style="padding-left:75px;font-size:22px;">
    ...
    a monthly basis over the agreed loan term. 
        <button class="btn" onclick="window.location.href = './pages/business_loan.php'">Apply</button>
    </pre>
</div>
</div>
<!-- ======cart2========== -->
<div class="carts">
    ...
    <div class="cart1">
        <img style="border-radius:10px;width:390px;height:300px;" src="./images/Instant_loan.png" alt="personal loan Image">
        <pre style="padding-left:75px;font-size:22px;">
    ...
    borrower’s credit score, income, and other factors.
        <button class="btn" onclick="window.location.href = './pages/instant_loan.php'">Apply</button>
    </pre>
</div>
</div>
<!-- ======cart3========== -->
<div class="carts">
    ...
    <div class="cart1">
        <img style="border-radius:10px;width:390px;height:300px;" src="./images/home_loan.png" alt="personal loan Image">
        <pre style="padding-left:75px;font-size:22px;">
    ...
    housing loans so that you make an informed choice.
        <button class="btn" onclick="window.location.href = './pages/home_loan.php'">Apply</button>
    </pre>
</div>
</div>
<!-- ======cart4========== -->
<div class="carts">
    ...
    <div class="cart1">
        <img style="border-radius:10px;width:390px;height:300px;" src="./images/mortgage_loan.jpg" alt="personal loan Image">
        <pre style="padding-left:75px;font-size:22px;">
    ...
    can afford.
        <button class="btn" onclick="window.location.href = './pages/mortgage_loan.php'">Apply</button>
    </pre>
</div>
</div>
<!-- ======cart5========== -->
<div class="carts">
    ...
    information.
        <button class="btn" onclick="window.location.href = './pages/mudra_loan.php'">Apply</button>
    </pre>
</div>
</div>
<!-- ======cart6========== -->
<div class="carts">
    ...
    <div class="cart1">
        <img style="border-radius:10px;width:390px;height:300px;" src="./images/project_loan.png" alt="personal loan Image">
        <pre style="padding-left:75px;font-size:22px;">
    ...
    or innovative initiatives.
        <button class="btn" onclick="window.location.href = './pages/project_loan.php'">Apply</button>
    </pre>
</div>
</div>
<!-- ======cart7========== -->
<div class="carts">
    ...
    <div class="cart1">
        <img style="border-radius:10px;width:390px;height:300px;" src="./images/education_loan.png" alt="personal loan Image">
        <pre style="padding-left:75px;font-size:22px;">
